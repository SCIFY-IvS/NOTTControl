...
/* Series for the nutation */
   ...
   dp -= sin_ ( f2 + d4 + om2 );                    /* 105  */

   dp += sin_ ( el2 + d2 );                         /* 104  */

   dp -= sin_ ( el - f2 + d2 );                     /* 103  */

   dp -= sin_ ( el + elp - d2 + om );               /* 102  */

   dp -= sin_ ( - elp + f2 + om );                  /* 101  */

   dp -= sin_ ( el - f2 - d2 );                     /* 100  */
   ...
   dp += sin_ ( - el - elp + d2 + om );             /*  96  */

   dp += sin_ ( elp + f2 + om );                    /*  95  */

   dp -= sin_ ( el + f2 - d2 );                     /*  94  */

   dp += sin_ ( el3 + f2 - d2 + om2 );              /*  93  */

   dp += sin_ ( f4 - d2 + om2 );                    /*  92  */

   dp -= sin_ ( el + d2 + om );                     /*  91  */

   dp -= sin_ ( el2 + f2 + d2 + om2 );              /*  90  */

   a = el2 + f2 - d2 + om;                         /*  89  */
   dp += sin_ ( a );
   de -= cos_ ( a );

   dp += sin_ ( el - elp - d2 );                    /*  88  */

   dp += sin_ ( - el + f4 + om2 );                  /*  87  */
   ...
   dp += 3.0 * sin_ ( el + f2 );                    /*  67  */

   dp -= 3.0 * sin_ ( el + elp );                   /*  66  */

   dp -= 4.0 * sin_ ( d );                          /*  65  */

   dp += 4.0 * sin_ ( el - f2 );                    /*  64  */

   dp -= 4.0 * sin_ ( elp - d2 );                   /*  63  */

   a = el2 + f2 + om;                              /*  62  */
   dp -= 5.0 * sin_ ( a );
   de += 3.0 * cos_ ( a );

   dp += 5.0 * sin_ ( el - elp );                   /*  61  */
   ...
   a = - el + om;                                  /*  39  */
   dp += ( - 58.0 -  0.1 * t ) * sin_ ( a );
   de += 32.0 * cos_ ( a );

   a = el + om;                                    /*  38  */
   dp += ( 63.0 + 0.1 * t ) * sin_ ( a );
   de -= 33.0 * cos_ ( a );
   ...
   a = el + f2 + om2;                              /*  34  */
   dp -= 301.0 * sin_ ( a );
   de += ( 129.0 - 0.1 * t ) * cos_ ( a );

   a = f2 + om;                                    /*  33  */
   dp += ( - 386.0 - 0.4 * t ) * sin_ ( a );
   de += 200.0 * cos_ ( a );

   dp += ( 712.0 + 0.1 * t ) * sin_ ( el );         /*  32  */
   de -= 7.0 * cos_( el );

   a = f2 + om2;                                   /*  31  */
   dp += ( -2274.0 - 0.2 * t ) * sin_ ( a );
   de += ( 977.0 - 0.5 * t ) * cos_ ( a );

   dp -= sin_ ( elp + f2 - d2 );                    /*  30  */

   dp += sin_ ( - el + d + om );                    /*  29  */

   dp += sin_ ( elp + om2 );                        /*  28  */

   dp -= sin_ ( elp - f2 + d2 );                    /*  27  */

   dp += sin_ ( - f2 + d2 + om );                   /*  26  */

   dp += sin_ ( el2 + elp - d2 );                   /*  25  */
   ...
   dp += ( 17.0 - 0.1 * t ) * sin_ ( elp2 );        /*  16  */

   dp -= 22.0 * sin_ ( f2 - d2 );                   /*  15  */
   ...
   a = f2 - d2 + om;                               /*  13  */
   dp += ( 129.0 + 0.1 * t ) * sin_ ( a );
   de -= 70.0 * cos_ ( a );

   a = - elp + f2 - d2 + om2;                      /*  12  */
   dp += ( 217.0 - 0.5 * t ) * sin_ ( a );
   de += ( -95.0 + 0.3 * t ) * cos_ ( a );

   a = elp + f2 - d2 + om2;                        /*  11  */
   dp += ( - 517.0 + 1.2 * t ) * sin_ ( a );
   de += ( 224.0 - 0.6 * t ) * cos_ ( a );

   dp += ( 1426.0 - 3.4 * t ) * sin_ ( elp );       /*  10  */
   de += ( 54.0 - 0.1 * t) * cos_ ( elp );

   a = f2 - d2 + om2;                              /*   9  */
   dp += ( - 13187.0 - 1.6 * t ) * sin_ ( a );
   de += ( 5736.0 - 3.1 * t ) * cos_ ( a );
   ...
   dp -= 3.0 * sin_ ( el - elp - d );               /*   6  */

   a = - el2 + f2 + om2;                           /*   5  */
   dp -= 3.0 * sin_ ( a );
   de +=       cos_ ( a );

   dp += 11.0 * sin_ ( el2 - f2 );                  /*   4  */

   a = - el2 + f2 + om;                            /*   3  */
   dp += 46.0 * sin_ ( a );
   de -= 24.0 * cos_ ( a );

   dp += ( 2062.0 + 0.2 * t ) * sin_ ( om2 );       /*   2  */
   de += ( - 895.0 + 0.5 * t ) * cos_ ( om2 );

   dp += ( - 171996.0 - 174.2 * t) * sin_ ( om );   /*   1  */
   de += ( 92025.0 + 8.9 * t ) * cos_ ( om );

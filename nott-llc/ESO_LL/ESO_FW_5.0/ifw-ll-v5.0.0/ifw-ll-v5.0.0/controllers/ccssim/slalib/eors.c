...
**
**  2)  To transform a geocentric apparent right ascension into the
**      equivalent right ascension in the celestial intermediate
**      reference system (CIRS), add the equation of the origins.
**
**  3)  The algorithm is from Wallace & Capitaine (2006).
**
**  Reference:
**
**     Wallace, P. & Capitaine, N., 2006, Astron.Astrophys. 459, 981.
**
**  Last revision:   24 February 2008
**
...
/* Evaluate Capitaine & Wallace (2006) expression (16). */
   ...
   return s - ( ( p != 0.0 || q != 0.0 ) ? atan2_ ( q, p ) : 0.0 );

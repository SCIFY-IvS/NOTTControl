      ...
      /* Iterate until converged. */
         ...
         /* Converged? */
            ...
            /* Shift from bottom 2 x 2 minor. */
               ...
               f = ( ( y - z ) * ( y + z )
                   + ( g - h ) * ( g + h ) ) / ( 2.0 * h * y );
               g = ( fabs_ ( f ) <= 1e15 ) ? rms ( f, 1.0 ) : fabs_ ( f );
               f = ( ( x - z ) * ( x + z )
                       + h * ( y / ( f + dsign ( g, f ) ) - h ) ) / x;
